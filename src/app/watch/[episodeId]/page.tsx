    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center">
        <div className="text-center">
          <svg className="w-12 h-12 mx-auto text-red-400/50 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex gap-3 justify-center">
            <button
              ...
              className="px-4 py-2 bg-accent hover:bg-accent-hover text-white rounded-lg text-sm transition"
            >
              再試行
            </button>
            <Link href="/" className="px-4 py-2 border border-dark-border text-dark-muted hover:text-dark-text rounded-lg text-sm transition">
              ホームに戻る
            </Link>
          </div>
        </div>
